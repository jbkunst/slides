...
# `r ico("exclamation-triangle")` Quien soy y que haré(mos) { .center .left data-background="https://media.giphy.com/media/3o7buirYcmV5nSwIRW/giphy.gif" }
...
hc %>% 
  hc_chart(
    type = "column", borderColor = '#EBBA95', borderRadius = 10,
...
```{r include=FALSE}
htmlwidgets::saveWidget(hcf, "demo_1.html")
```
...
# `r ico("fast-forward ")` `hchart` al rescate <br><small>y otros atajos</small>{ .white .left data-background="img/drakehotlinebling.jpg" }
