...
class: center, middle, clear, bkgd-pumpkin
...
<html><div style='float:left'></div><hr color='#272822' size=1px width=720px></html> 
...
background-image: url(https://i.pinimg.com/originals/c4/03/8f/c4038f9866fbbdcfad725c0fed348104.jpg)
...
p <- data %>% 
  ...
  ggplot(aes(mediahora, subidas_laboral_promedio, color = paraderosubida)) +
...
Hasta ahora hemos usado correlaciones que miden asociacion linea 
y no es um indicador robusto para uso de distancia
