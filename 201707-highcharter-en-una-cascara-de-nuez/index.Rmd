...
- Presentarles highcharter
- Que n ació por el gusto de aprender
- 
...
- __highcharter__ no es más que el _wrapper_ highcharts para R<span class="fragment">. Por lo que hereda
...
```{r}
hc <- hc %>% 
  hc_add_series(data = c(20, 25, 37, 30, 70), name = "Usuarios por mes")
hc
```
...
hc %>% 
 hc_chart(
   borderColor = '#EBBA95', borderRadius = 10, borderWidth = 2,
