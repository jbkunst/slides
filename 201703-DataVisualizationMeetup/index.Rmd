...
c <- d1 %>% 
  ...
  {cor(.[[1]], .[[2]])}
```
Correlación igual a `r round(c, 3)`
...
# En definitiva {.center}

- 

# A ustedes y a los organizadores. Conversemos! {.section-title-white .center data-background="http://i.giphy.com/5xtDarmwsuR9sDRObyU.gif"}
