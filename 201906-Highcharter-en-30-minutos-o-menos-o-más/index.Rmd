...
## `r ico("hand-paper-o", "#ff0033", class="greeting")`, Hola! Que haremos?

- Por que la visualización?
- Que es HighchartsJS, y que es `highcharter`? 
...
hc2 <- hc %>% 
  hc_xAxis(
    ...
    plotLines = list(list(
      label = list(text = "Esto es una linea (plotLine)"),
  ...
  hc_yAxis(
    ...
    plotBands = list(list(
      ...
      label = list(text = "Esto es una banda (plotBand)")
    ))
    ) %>%
    hc_annotations(
    list(
...
## Financial times { data-backgorund=#FFF1E0 }

```{r}
hc_add_theme(hc, hc_theme_ft())
```

## Alone { data-backgorund=#34495e }
